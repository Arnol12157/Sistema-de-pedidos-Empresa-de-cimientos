...
$query_precio = "SELECT * FROM precios;";
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Modificacion precios</li>
        </ul>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_precio = mysql_fetch_array($resultado_precio))
                            {
                                ...
                                echo "<td><a type='button' class='btn btn-primary' href='modificar_precio.php?idp=" . $id_precio ."'>Modificar</a></td>";
                                echo "</tr>";
                            }
                            ?>
                            </tbody>
