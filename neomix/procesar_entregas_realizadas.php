...
$query_pedidos = "SELECT * FROM pedidos WHERE estado='T';";
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Procesar entregas realizadas</li>
        </ul>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_pedido = mysql_fetch_array($resultado_pedidos))
                            {
                                ...
                                $query_clienten="SELECT * FROM entregas WHERE id_cliente='$id_cliente' AND estado='T' AND id_pedido=$id_pedido";
                                $resultado_clienten=mysql_query($query_clienten,$conex);
                                $dato_clienten=mysql_fetch_array($resultado_clienten);
                                $iden=$dato_clienten['id_entrega'];
                                echo "<td>" . $dato_clienten['id_entrega'] . "</td>";

                                if(strcasecmp($dato_cliente['estado'],'A')==0)
                                {
                                    echo "<td><a type='button' class='btn btn-primary' href='completar_proceso_entregas.php?idp=".$id_pedido."&ien=".$iden."'>Procesar entrega</a></td>";
                                }
