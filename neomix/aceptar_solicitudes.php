...
$query_solicitudes_particulares = "SELECT * FROM solicitudes_clientes WHERE razon_social='' AND estado='S';";
$resultado_solicitudes_particulares = mysql_query($query_solicitudes_particulares, $conex);

$query_solicitudes_empresas = "SELECT * FROM solicitudes_clientes WHERE nombres='' AND estado='S';";
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Aceptar solicitudes</li>
        </ul>
                            ...
                            <tbody>
                                <?php
                                    while ($dato_cliente_p = mysql_fetch_array($resultado_solicitudes_particulares))
                                    {
                                        ...
                                        echo "<td><a type='button' class='btn btn-primary' href='completar_solicitud_p.php?idc=" . $id_cliente_p ."'>Aceptar</a></td>";
                                        echo "</tr>";
                                    }
                                ?>
                            </tbody>
                        ...
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                while ($dato_cliente_e = mysql_fetch_array($resultado_solicitudes_empresas))
                                {
                                    ...
                                    echo "<td><a type='button' class='btn btn-primary' href='completar_solicitud_p.php?idc=" . $id_cliente_e ."'>Aceptar</a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
