...
header("Content-Disposition: attachment; filename=Pedidos_pendientes.xls");
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
        <td colspan="6"><CENTER><strong>REPORTE DE PEDIDOS PENDIENTES</strong></CENTER></td>
    </tr>
    <tr>
        ...
        <td bgcolor="#adff2f"><strong>Lugar de entrega</strong></td>
