                            ...
                            <div class="section">
                                <div class="section-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" disabled class="form-control" placeholder="<?php echo $dato_cliente['nombres'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Apellidos</label>
                                        <div class="col-md-9">
                                            <input type="text" disabled class="form-control" placeholder="<?php echo $dato_cliente['apellidos'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" disabled class="form-control" name="idc" value="<?php echo $dato_cliente['id_cliente'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
