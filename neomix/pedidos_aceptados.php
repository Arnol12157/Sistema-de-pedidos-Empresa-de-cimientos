...
if(empty($fecha_final) || empty($fecha_inicial))
{
    echo '<script language = javascript>
                ...
                self.location = "pedidos_aceptados_pri.php"
              </script>';
}
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Pedidos aceptados</li>
            <div class="text-right col-md-3">
                <a type="button" class="btn btn-success" href="pdf_pedidos_aceptados.php?fi=<?php echo $fecha_inicial ?>&ff=<?php echo $fecha_final ?>">REPORTE EN PDF</a>
            </div>
        </ul>
        <ul class="nav navbar-nav navbar-left">
            <div class="text-right col-md-3">
                <a type="button" class="btn btn-success" href="excel_pedidos_aceptados.php?fi=<?php echo $fecha_inicial ?>&ff=<?php echo $fecha_final ?>">REPORTE EN EXCEL</a>
            </div>
        </ul>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_pedido = mysql_fetch_array($resultado_pedidos))
                            {
                                ...
                                echo "<td><a type='button' class='btn btn-primary' href='ver_pedidos_aceptados.php?idp=".$id_pedido."&num=".$id_cliente."'>Detalle del pedido</a></td>";
                                echo "</tr>";
                            }
                            ?>
                            </tbody>
