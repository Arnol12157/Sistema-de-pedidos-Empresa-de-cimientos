...
$query_solicitudes_particulares = "SELECT * FROM clientes WHERE (estado='M') AND razon_social='';";
$resultado_solicitudes_particulares = mysql_query($query_solicitudes_particulares, $conex);

$query_solicitudes_empresas = "SELECT * FROM clientes WHERE (estado='M') AND nombres='';";
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Autorizar modificaciones</li>
        </ul>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_cliente_p = mysql_fetch_array($resultado_solicitudes_particulares))
                            {
                                ...
                                echo "<td><a type='button' class='btn btn-primary' href='ver_modificaciones_p.php?idc=" . $id_cliente_p ."'>Ver</a></td>";
                                echo "</tr>";
                            }
                            ?>
                            </tbody>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_cliente_e = mysql_fetch_array($resultado_solicitudes_empresas))
                            {
                                ...
                                echo "<td><a type='button' class='btn btn-primary' href='ver_modificaciones_p.php?idc=" . $id_cliente_e ."'>Ver</a></td>";
                                echo "</tr>";
                            }
                            ?>
                            </tbody>
