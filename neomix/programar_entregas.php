...
$query_pedidos = "SELECT * FROM pedidos WHERE estado='A' OR estado='M';";
$resultado_pedidos = mysql_query($query_pedidos, $conex);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Programar entregas</title>
...
<div class="app app-default">
    ...
    <div class="app-container">
        ...
        <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Programar entregas</li>
        </ul>
                    ...
                    <div class="card-body no-padding">
                        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                            ...
                            while ($dato_pedido = mysql_fetch_array($resultado_pedidos))
                            {
                                ...
                                {
                                    echo "<td><a type='button' class='btn btn-primary' href='completar_entrega.php?idp=".$id_pedido."'>Programar entrega</a></td>";
                                }
