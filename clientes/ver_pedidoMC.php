                                ...
                                <div class="section-body">
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="mytable">
                                            ...
                                            {
                                                echo "<tr>";
                                                echo "<td><input type='text' class='' disabled value='".$dato_detalle['articulo']."' /></td>";
                                                echo "<td><input type='number' class='quant' disabled value='".$dato_detalle['cantidad_ent']."' min='0' /></td>";
                                                echo "<td><input type='date' class='' disabled value='".$dato_detalle['fecha_ent']."' min='0' /></td>";
                                                echo "<td><input type='number' class='quant' disabled value='".$dato_detalle['pendiente']."' min='0' /></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                            <tr>
