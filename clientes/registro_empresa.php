            ...
            <div class="app-body">
                ...
                <div style="background-color: #fff; padding: 10%">
                    ...
                    <div class="app-form">
                        ...
                        <form action="Lregistro_empresa.php" method="post">
...
<!--                            </div>-->
                            <div class="input-group">
                                ...
                                <input name="razon" type="text" class="form-control" placeholder="Razon social" aria-describedby="basic-addon1" required onkeyup="conMayusculas(this)"/>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon2">
                                    <i class="fa fa-user" aria-hidden="true"></i>
                                </span>
                                <input name="per_contacto" type="text" class="form-control" placeholder="Persona de contacto" aria-describedby="basic-addon2" required onkeyup="conMayusculas(this)"/>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon2">
                                    <i class="fa fa-phone" aria-hidden="true"></i>
                                </span>
                                <input name="telefono_contacto" type="number" class="form-control" placeholder="Telefono de contacto" aria-describedby="basic-addon2" required/>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon2">
                            ...
                            <div class="input-group">
                                ...
                                <input name="telefono" type="number" class="form-control" placeholder="Telefono" aria-describedby="basic-addon2"/>
                            </div>
                            ...
                            <div class="text-center">
                                <input type="submit" id="botreg" style="display: none" class="btn btn-success btn-submit" value="Registrarse"/>
                            </div>
                        </form>
                    </div>
                </div>
