        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form form-horizontal" action="Lentrega_domicilio.php" enctype="multipart/form-data" method="post">
                            <div class="section">
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="mytable">
                                            ...
                                            while ($dato_articulo = mysql_fetch_array($resultado_articulos))
                                            {
                                                ...
                                                echo "<td><input type='number' name='precio[]' class='price' readonly value='".$dato_articulo['precio_domicilio']."' min='0' /></td>";
